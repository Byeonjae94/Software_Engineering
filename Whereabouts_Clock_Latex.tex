...
- We refer to this blog to turn around the stepping motor. \\
	...
	\subsection{Clock Hardware Components}
		...
		\begin{figure}[h]
				\includegraphics[width=0.47\textwidth]{Figure29.png}
				\caption{Caption29}
				\label{fig29}
		\end{figure}
...
member. Each needle indicates his/her location.
		\begin{figure}[h]
				\includegraphics[width=0.44\textwidth]{Figure30.png}
				\caption{Caption30}
				\label{fig30}
		\end{figure}
...
\section{Use Cases}		
	\subsection{Main Use Cases}
		...
		- User downloads our Whereabouts-SE Project APP in google store. \\
			\begin{figure}[h]
				\includegraphics[width=0.42\textwidth]{Figure31.png}
				\caption{Caption31}
				\label{fig31}
			\end{figure}
		\\
		...
		\begin{figure}[h]
				\includegraphics[width=0.5\textwidth]{Figure33.png}
				\caption{Caption33}
				\label{fig33}
		\end{figure}
		\\\\\\\\\\\\\\\\\
...
\section{SOFTWARE INSTALLATION GUIDE }		
	 \textbf{Software Installation Guide}	
		\begin{figure}[h]
				\includegraphics[width=0.45\textwidth]{Figure35.png}
				\caption{Caption35}
				\label{fig35}
		\end{figure}	\\
